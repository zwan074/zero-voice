...
**[Feb. 3, 2026]** We note that synthetic speech generated by the Zero-Voice approach exhibits a domain mismatch, and we propose a novel method to address this issue. [[Score-Distribution-Matching](https://github.com/zwan074/score-distribution-matching)]. This work has been acceptted by ICASSP 2026!
...
3. Te Reo ASR checkpoint  [[te-reo-asr](https://huggingface.co/spaces/zwan074/whisper-te-reo)]
## Installation
